...
namespace PharmacyApp.Tests.Unit.Features.ProductCatalogue
{
    ...
    public class ProductCatalogueServiceTests
    {
            ...
            Dictionary<string, float>? activeSubstances = null)
        {
            ...
            if (batches != null)
            {
                foreach (KeyValuePair<DateOnly, int> batch in batches)
                {
            ...
            {
                foreach (KeyValuePair<string, float> substance in activeSubstances)
                {
        ...
        public void GetItems_NullSearch_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(null);
        ...
        public void GetItems_Pagination_FirstPageReturnsExactPageSizeCount()
        {
            ...
            List<Item> firstPage = productCatalogueService.GetItems(null, page: 0, pageSize: 2);
        ...
        public void GetItems_Pagination_SecondPageReturnsRemainingItemsCount()
        {
            ...
            List<Item> secondPage = productCatalogueService.GetItems(null, page: 1, pageSize: 2);
        ...
        public void GetItems_PageBeyondItems_ReturnsEmptyListCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(null, page: 5, pageSize: 10);
        ...
        public void GetItems_DefaultPageSize_LimitsResultsToTenItems()
        {
            List<Item> items = new List<Item>
            {
                CreateItem(1, "Item1", "P", "C", 10f, 50),
                CreateItem(2, "Item2", "P", "C", 10f, 50),
                CreateItem(3, "Item3", "P", "C", 10f, 50),
                CreateItem(4, "Item4", "P", "C", 10f, 50),
                CreateItem(5, "Item5", "P", "C", 10f, 50),
                CreateItem(6, "Item6", "P", "C", 10f, 50),
                CreateItem(7, "Item7", "P", "C", 10f, 50),
                CreateItem(8, "Item8", "P", "C", 10f, 50),
                CreateItem(9, "Item9", "P", "C", 10f, 50),
                CreateItem(10, "Item10", "P", "C", 10f, 50),
            ...
            Assert.That(result.Count, Is.EqualTo(ProductCatalogueService.DefaultPageSize));
        }
        ...
        public void GetItems_SearchByName_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems("Paracetamol");
        ...
        public void GetItems_SearchPartialMatch_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems("para");
        ...
        public void GetItems_SearchNoMatch_ReturnsEmptyCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems("Aspirin");
        ...
        public void GetItems_SearchWithNullItemName_DoesNotThrowAndReturnsZeroCount()
        {
            List<Item> items = new List<Item>
            {
                CreateItem(1, null!, "Bayer", "Medicine", 10f, 50)
            };

            mockItemsRepository.Setup(repository => repository.GetAllItems()).Returns(items);

            List<Item> result = productCatalogueService.GetItems("test");
        ...
        public void GetItems_SearchSkipsItemsWithNullName_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems("para", pageSize: 20);
        ...
        public void GetItems_PriceRangeMinIsNegative_ThrowsArgumentException()
        {
            ...
            Action action = () => productCatalogueService.GetItems(
                null,
        ...
        public void GetItems_PriceExactlyOnMinBoundary_ReturnsItem()
        {
            List<Item> items = new List<Item>
            {
                CreateItem(1, "ExactMin", "Bayer", "Med", 10f, 50)
            };
            ...
            List<Item> result = productCatalogueService.GetItems(
                null,
                priceRanges: new List<(float, float)> { (10f, 20f) });
        ...
        public void GetItems_PriceExactlyOnMaxBoundary_ReturnsItem()
        {
            List<Item> items = new List<Item>
            {
                CreateItem(1, "ExactMax", "Bayer", "Med", 20f, 50)
            };
        ...
        public void GetItems_PriceOutsideBoundary_ReturnsEmpty()
        {
            List<Item> items = new List<Item>
            {
                CreateItem(1, "TooExpensive", "Bayer", "Med", 100f, 50)
            };
        ...
        public void GetItems_StockIsZero_LowStockFilterExcludesIt()
        {
            List<Item> items = new List<Item>
            {
                CreateItem(1, "EmptyStock", "Bayer", "Med", 10f, 0)
            };
        ...
        public void GetItems_StockExactlyAtThreshold_LowStockFilterExcludesIt()
        {
            List<Item> items = new List<Item>
            {
                CreateItem(1, "ThresholdStock", "Bayer", "Med", 10f, ProductCatalogueService.LowStockThreshold)
            };
        ...
        public void GetItems_StockFilterInStock_ExcludesOutOfStockItems()
        {
            ...
            Assert.That(result[0].Name, Is.EqualTo("InStock"));
        }
        ...
        public void GetItems_InvalidStockFilter_ReturnsOriginalCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(
                null,
                stockFilter: "invalid_filter_string");
        ...
        public void GetItems_DiscountedTrue_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(null, discounted: true);
        ...
        public void GetItems_DiscountedFalse_ReturnsNonDiscountedItemName()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(null, discounted: false);

            Assert.That(result[0].Name, Is.EqualTo("NotDiscounted"));
        }
        ...
        public void GetItems_PriceRangeFilter_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(
                null,
                priceRanges: new List<(float, float)> { (0f, 49.99f) });
        ...
        public void GetItems_CategoryFilter_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(
                null,
                categories: new List<string> { "Supplements" });
        ...
        public void GetItems_SubstanceFilter_ReturnsCorrectCount()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(
                null,
                substances: new List<string> { "Aspirin" });
        ...
        public void GetItems_SortByPriceAscending_FirstItemIsCheapest()
        {
            ...
            Assert.That(result[0].Name, Is.EqualTo("Cheap"));
        }
        ...
        public void GetItems_SortByPriceAscending_LastItemIsMostExpensive()
        {
            ...
            Assert.That(result[2].Name, Is.EqualTo("Expensive"));
        }
        ...
        public void GetItems_SortByPriceDescending_FirstItemIsMostExpensive()
        {
            ...
            Assert.That(result[0].Name, Is.EqualTo("Expensive"));
        }
        ...
        public void GetItems_SortByNewestAscending_FirstItemHasOldestOrNoFutureBatch()
        {
            ...
            Assert.That(result[0].Name, Is.EqualTo("NoFutureBatch"));
        }
        ...
        public void GetItems_SortByNewestDescending_FirstItemHasFurthestFutureBatch()
        {
            ...
            Assert.That(result[0].Name, Is.EqualTo("FarFuture"));
        }
        ...
        public void GetItems_InvalidSortBy_ReturnsFirstItemInOriginalOrder()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(null, sortBy: "invalid_sort_string");
        ...
        public void GetItems_NullSortBy_ReturnsItemsInOriginalOrder()
        {
            ...
            List<Item> result = productCatalogueService.GetItems(null, sortBy: null);
